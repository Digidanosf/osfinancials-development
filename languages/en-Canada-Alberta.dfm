object TTranslationSaveObject
  aTranslationCollection = <
    ...
    item
      IndexID = 1000000
      Text = 
        'English Master File for Alberta, Canada (en-CA-AB) - Optimized f' +
        'or GST and Common Law Terminology - Do Not Translate. To customi' +
    ...
    item
      IndexID = 3409
      Text = 'Postal code / GST ID / reg. no. lookup'
    end
    item
      IndexID = 3410
    ...
    item
      IndexID = 906339
      Text = 'GST and Business numbers (BN)'
    end
    item
      IndexID = 3568
    ...
    item
      IndexID = 3675
      Text = 'Customer list with GST/QST numbers'
    end
    item
      IndexID = 3676
      Text = 
    ...
    item
      IndexID = 906553
      Text = 'Supplier list with GST numbers'
    end
    item
      IndexID = 3685
