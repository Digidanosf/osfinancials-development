object TTranslationSaveObject
  aTranslationCollection = <
    ...
    item
      IndexID = 1000000
      Text = 
        'English Master File for Saskatchewan, Canada (en-CA-SK) - Optimi' +
        'zed for GST/PST and Common Law Terminology - Do Not Translate. T' +
        'o customize this language file, create a copy.'
    end
    item
      IndexID = 1000001
    ...
    item
      IndexID = 906339
      Text = 'GST, PST, and SK Business numbers'
    end
    item
      IndexID = 3568
    ...
    item
      IndexID = 3675
      Text = 'Customer list with GST/PST numbers'
    end
    item
      IndexID = 3676
      Text = 
    ...
    item
      IndexID = 906553
      Text = 'Supplier list with GST/PST numbers'
    end
    item
      IndexID = 3685
