object TTranslationSaveObject
  aTranslationCollection = <
    ...
    item
      IndexID = 1000000
      Text = 
        'English Master File for English United States of America (en-US)' +
        ' - Do Not Translate. To customize this language file, create a c' +
        'opy.'
    end
    item
      IndexID = 1000001
    ...
    item
      IndexID = 3300
      Text = 'Colors for out of inventory'
    end
    item
      IndexID = 3301
