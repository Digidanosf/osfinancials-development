object TTranslationSaveObject
  aTranslationCollection = <
    ...
    item
      IndexID = 1000000
      Text = 
        'English Master File for Ontario, Canada (en-CA-ON) - Optimized f' +
        'or HST and Common Law Terminology - Do Not Translate. To customi' +
        'ze this language file, create a copy.'
    end
    item
      IndexID = 1000001
    ...
    item
      IndexID = 3409
      Text = 'Postal code / HST ID / reg. no. lookup'
    end
    item
      IndexID = 3410
    ...
    item
      IndexID = 906339
      Text = 'HST and Business numbers (BN)'
    end
    item
      IndexID = 3568
    ...
    item
      IndexID = 3675
      Text = 'Customer list with HST numbers'
    end
    item
      IndexID = 3676
      Text = 
    ...
    item
      IndexID = 906553
      Text = 'Supplier list with HST numbers'
    end
    item
      IndexID = 3685
