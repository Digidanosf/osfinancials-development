object TTranslationSaveObject
  aTranslationCollection = <
    ...
    item
      IndexID = 544
      Text = 
        'Welcome to the <@APPNAME@> Set of Books wizard. Please select an' +
        ' option and click on the [Next] button, or click on the [Cancel]' +
        ' button to cancel the creation of a new Set of Books.'
    end
    item
      IndexID = 543
      Text = 'Finish'
