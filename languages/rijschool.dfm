object TTranslationSaveObject
  aTranslationCollection = <
    ...
    item
      IndexID = 455
      Text = 
        'This directory does not contain a osFinancials 2.01, 2.02 or 2.0' +
        '3 Set of Books.'
    end
    item
      IndexID = 456
    ...
    item
      IndexID = 546
      Text = 'Convert from an older osFinancials (v 2.01, 2.02, 2.03)?'
    end
    item
      IndexID = 557
    ...
    item
      IndexID = 2880
      Text = 
        'Please save this Repeating Invoice first. After re-opening you c' +
        'an add clients to the Invoice.'
    end
    item
      IndexID = 2891
      Text = '&Telephone'
    ...
    item
      IndexID = 3067
      Text = 'Error: closing shift! please try again!'
    end
    item
      IndexID = 3068
    ...
    item
      IndexID = 901003
      Text = 'Subscriptions ready for process'
    end
    item
      IndexID = 901004
      Text = 'Line value'
    ...
    item
      IndexID = 3131
      Text = 'Reorder level you items will be reordered until this quantity'
    end
    item
      IndexID = 3132
      Text = 
        'If your stock goes below this then the system wil reorder until ' +
    ...
    item
      IndexID = 3153
      Text = 
        'If you have openoffice installed you can edit this as HTML by do' +
        'uble clicking in this text field!'
    end
    item
      IndexID = 3154
      Text = 'Options'
    ...
    item
      IndexID = 3210
      Text = 'You are registered sucessfully ! Your registration name'
    end
    item
      IndexID = 3211
      Text = 'Usage'
    ...
    item
      IndexID = 3238
      Text = 'Email header text'
    end
    item
      IndexID = 3239
      Text = 'Batchsend max mail'
    end
    item
      IndexID = 3240
    ...
    item
      IndexID = 3250
      Text = 'CC (multiple seperate with ;)'
    end
    item
      IndexID = 3251
      Text = 'BCC (multiple seperate with ;)'
    end
    item
      IndexID = 3252
      Text = 'Send e-mail'
    ...
    item
      IndexID = 3253
      Text = 
        'No extra CC found please enter a emailadress in text box below t' +
        'his button!'
    end
    item
      IndexID = 3254
      Text = 'No pop password enterd'
    end
    item
      IndexID = 3255
    ...
    item
      IndexID = 3267
      Text = 'Supplier stockcode'
    end
    item
      IndexID = 3268
      Text = 'Prefferd Supplier'
    end
    item
      IndexID = 3269
      Text = 'Next costprice'
    ...
    item
      IndexID = 3272
      Text = 'Link bankaccount from import to accounts'
    end
    item
      IndexID = 3273
      Text = 'Link all records with current account bankaccounts'
    end
    item
      IndexID = 3274
      Text = 'Select from account openitem list'
    end
    item
      IndexID = 3275
    ...
    item
      ...
      Text = 
        ...
        'rted'#13#10'bankline to see if the text is in that string. Text will b' +
        'e searched uppercased.'
    end
    item
      IndexID = 3277
