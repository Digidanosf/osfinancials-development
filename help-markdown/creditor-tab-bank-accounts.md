# Creditor accounts - Bank accounts tab

***

This allows you to use references for the [**Bank import plugin**](<plugin-bank-import.md>).

![Image](<lib/creditors-tab-bank-01.png>)
