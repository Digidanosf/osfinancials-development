...
| ![Image](<lib/admon-warning.png>) | *Before proceeding with the next step, remember to **SAVE** the PETTYCASH-TEMPLATE.ods (Open Document Spreadsheet).*&nbsp; |
| --- | --- |
...
4) Click on **F9:Process** icon and select the “*Delimited file import*” option and click **OK**.

![Image](<lib/petty-cash-template-import-csv.png>)

The "*Open*" screen will be displayed.

![Image](<lib/petty-cash-batch-import-1.png>)

7. Navigate and select the Petty cash batch file (e.g. “*PETTYCASH-2024-03.csv*”) to import and click **Open**.&nbsp;

*Warning saving the document PETTYCASH-2024-03:*\
*Only the active sheet was saved.*

![Image](<lib/bank-import-petty-cash-imported-csv.png>)

8. After importing the petty cash transactions, you may need to change / edit the imported petty cash transactions:
...
2. Click on the **F5:Balance** icon. This will generate balancing transactions to the Petty cash bank account. ![Image](<lib/bank-import-petty-cash-batch-balance.png>)
2. Click on the **F8:List** icon to print a list of the transactions in the unposted batch.&nbsp;

| ![Image](<lib/admon-note.png>) | *To include Tax (VAT/GST/Sales tax) amounts in the **List batch - Unposted batch** report,you need to balance the batch first.*&nbsp; *To do this, you need to go to **F9:Process** and choose the **Balance batch**.*&nbsp; *It will generate balancing entries and include the Tax (VAT/GST/Sales tax) amounts on the **List batch - Unposted batch** **report** .*&nbsp; |
| --- | --- |


![Image](<lib/bank-import-petty-cash-batch-list-printed.png>)

4. Click on the **F6:Post** icon to update (post) the transactions to the ledger.
...
- &nbsp;
  ...
  - **Batch id** (e.g. 38 automatically generated). This will list only the transactions for a specific batch (journal).&nbsp;
  - **Account code** (e.g. B820-000 Petty cash, G210-030 Repairs G230-000 Stationery, T860-020 Input Tax Standard - 15%). This will list the transactions for a specific account.
...
| **Batch view**&nbsp; |
| --- |
| ![Image](<lib/bank-import-petty-cash-imported-csv-t-account.png>) |
...
![Image](<lib/bank-import-petty-cash-imported-csv-t-accoun1.png>)
