# Column balances debtors - Debit / Credit

***

The Column balances debtors D/C report type list the debit and credit balances of the transactions totals for the for the individual debtor (customer / client) accounts for each period.&nbsp;

You may select to list all debtor (customer / client) accounts, or only those accounts with balances.&nbsp;

This report type cannot be printed but can be exported to a spreadsheet (e.g. OpenOfficeCalc / [LibreOffice Calc](<https://www.libreoffice.org/discover/calc/> "target=\"\_blank\"") or Microsoft Excel, etc.).

You may generate the transactions in a spreadsheet format in the [Column balances debtors](<ledger-debtor-column-balances1.md>) or the [Column balances debtors D/C](<ledger-debtor-column-balances2.md>) report types on the [Ledger analyser](<ledger-analyser.md>).&nbsp;

These transaction totals may&nbsp; be exported to an "*Export.txt*" file or "*Export.csv*" and opened in a spreadsheet.&nbsp;

| ![Image](<lib/admon-tip.png>) | *To view the transactions for a specific debtor (customer / client) account for a specific period, simply double-click on a period. The transactions will be displayed in the [**T-Account viewer***](<t-account-viewer.md>) *to filter, print or export the transactions.* |
| --- | --- |


| ![Image](<lib/admon-tip.png>) | *In addition to the [transaction reports*](<reports-debtors-transactions.md>)*, you may also view and filter transactions on the [Transactions*](<debtor-tab-transactions.md>) *tab of a selected debtor (customer / client) account.*&nbsp; |
| --- | --- |
...
# Example : Column balances debtors D / C![Image](<lib/column-balances-debtors-debit-credit.png>)

| ![Image](<lib/admon-tip.png>) | *Buttons **11, 10, 9, 8, 7, 6, 5, 4, 3, 2** and **1** at the bottom of the report - is shortcut keys to the last accessed [T-Account viewer*](<t-account-viewer.md>) *options or [Pivot*](<ledger-analyser-pivot.md>) *options. These shortcuts will be cleared when you [close active forms*](<close-active-forms.md>)*, or when you open the Set of Books.* |
| --- | --- |
...
| ![Image](<lib/admon-tip.png>) | *You may double-click on an account and/or in a specific period to list and view the transaction details in the [**T-Account viewer***](<t-account-viewer.md>)*. You may be print the transactions.*&nbsp; |
| --- | --- |


# View transactions in T-Account viewer

| ![Image](<lib/admon-tip.png>) | *You may double-click on a specific period of an account to list and view the transaction details in the [**T-Account viewer***](<t-account-viewer.md>)*. You may be print the transactions.*&nbsp; |
| --- | --- |


## Print transactions in T-Account viewer

![Image](<lib/column-balances-debtors-debit-credit-print.png>)
...
![Image](<lib/column-balances-debtors-debit-credit-exported.png>)
