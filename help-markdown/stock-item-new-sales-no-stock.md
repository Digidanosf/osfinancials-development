...
**To create a stock item - Sales (no stock):**&nbsp;

1. On the **Default** ribbon, select **Stock items** (**F12**).&nbsp;
1. Click on the **New** button.&nbsp; A blank Stock form will be displayed.&nbsp;
1. Select the "*Sales (no stock)"* stock item type. The Stock entry form is displayed as follows: \
![Image](<lib/stock-new-type-sales-no-stock.png>)
...
![Image](<lib/stock-new-type-sales-no-stock-ledger.png>)
