# Column balances debtors

***

The Column balances debtors report type list the net balances (debits *minus* credits) of the transactions totals for the for the individual debtor (customer / client) accounts for each period.&nbsp;
...
# Example : Column balances debtors

![Image](<lib/column-balances-debtors.png>)

| ![Image](<lib/admon-tip.png>) | *Buttons **12, 11, 10, 9, 8, 7, 6, 5, 4, 3, 2** and **1** at the bottom of the report - is shortcut keys to the last accessed [T-Account viewer*](<t-account-viewer.md>) *options or [Pivot*](<ledger-analyser-pivot.md>) *options. These shortcuts will be cleared when you [close active forms*](<close-active-forms.md>)*, or when you open the Set of Books.* |
| --- | --- |


This report cannot be printed but can be exported to a spreadsheet (e.g. OpenOfficeCalc / [LibreOffice Calc](<https://www.libreoffice.org/discover/calc/> "target=\"\_blank\"") or Microsoft Excel, etc.).
...
![Image](<lib/column-balances-debtors-print.png>)

## Export transactions in T-Account viewer&nbsp;

&nbsp;

![Image](<lib/column-balances-debtors-exported.png>)
