...
To list the debtor (customer / client) accounts which have been set to "*Disabled*" on the [**Accounting information**](<debtor-tab-accounting-info.md>) tab, you need to tick the "*Show disabled*" tick box and click on the **Filter** button.&nbsp;

![Image](<lib/debtors-list-screen-filter-disabled.png>)

| ![Image](<lib/admon-tip.png>) | *The "[Debtor listing - Credit control listing (Credit limit vs Current balance) as at...*](<debtors-list-credit-control.md>)*" report will display if a debtor (customer / client) account is disabled, or enabled.* &nbsp; |
| --- | --- |


| ![Image](<lib/admon-note.png>) | *If the "Show disabled" option is selected, and if you [Close active forms*](<close-active-forms.md>) *or when you reopen the Set of Books, it will by default list only the active (enabled) debtor (customer / client) accounts.*&nbsp; |
| --- | --- |
...
| ***Default*** | ***Sorted (selected) - Alphabetical list*** |
| --- | --- |
| ![Image](<lib/debtors-column-filter-list.png>) | ![Image](<lib/debtors-column-filter-list-sorted.png>) |


**To search for specific debtor (customer / client) accounts**![Image](<lib/grid-search-operators.png>)**:**

1. The filter options will display only those debtor (customer / client) accounts in your search or filter criteria. To do this, you may:

   1. **Search by** - The default option is none. It will list all the column headings. You may select any of these as an option.
   1. **Like** - Operator to find all debtor (customer / client) accounts with the same value, values greater than, smaller than, greater than or equal to, smaller than or equal to the values you have selected, or wish to enter.
   1. **Value** - Enter the value for the field type you have selected, for example, Postal code (if you have selected "*Postal code*" as the "*Search by*" option).

![Image](<lib/debtors-list-screen-column.png>)

2. Once you have selected or specified the search criteria, click on the **Filter** button. Only those debtor (customer / client) accounts as in your search or filter criteria or options will be listed.
2. If you need to clear your filter options and values, click on the **Clear** button. You may also click on any of the column headings to change the sorting sequence of the debtor (customer / client) accounts listed.

| ![Image](<lib/admon-tip.png>) | *You may also search for debtor (customer / client) accounts in the "Investigator" screen ([**Search***](<search-investigator.md>) *(**Default** ribbon)).*&nbsp; &nbsp; |
| --- | --- |
...
![Image](<lib/debtors-list-screen-columns-drag.png>)

| ![Image](<lib/admon-tip.png>) | *You may drag and drop any of the columns on the data band to the left band and the columns from the left band to the data band, to customise the grid for your requirements.*&nbsp; |
| --- | --- |


| ![Image](<lib/admon-note.png>) | *The sequence of the columns as set will be retained if you [close active forms*](<close-active-forms.md>) *or when you reopen the Set of Books.*&nbsp; |
| --- | --- |
...
![Image](<lib/debtors-list-screen-columns-bands.png>)
...
| ![Image](<lib/admon-tip.png>) | *You may use the **Up** arrows and/or the **Down** arrows **Right** or **Left** arrows keys to navigate the fields. You may use the **Space bar** to deselect (remove the tick) or to reselect (tick a field again).*&nbsp; |
| --- | --- |


![Image](<lib/debtors-list-screen-columns-hide-show.png>)
...
![Image](<lib/debtors-list-screen-columns-group.png>)
...
![Image](<lib/debtors-list-screen-columns-ungroup.png>)
...
&nbsp;![Image](<lib/debtors-list-screen-columns-filter.png>)
...
![Image](<lib/debtors-list-screen-columns-filter-01.png>)

| ![Image](<lib/admon-tip.png>) | ![Image](<lib/material-icon-filter-tick.png>)&nbsp; *- To temporarily clear the filter (show all records, remove the tick. To show the filtered records, add the tick again.*&nbsp; ![Image](<lib/material-icon-filter-close.png>) *- To delete the filter, click on the close icon.* &nbsp; |
| --- | --- |
...
1. Click on the **(Custom...)** option on a column list; or click on the **Customise** button.
...
4. Select a column from the list of available data applicable to the screen.&nbsp;
4. Select a filter condition. In this example, the **Between** is selected. Another field is opened to select another date.
...
## Conditions![Image](<lib/filter-custom-options-list.png>)
...
1. **Like** - list all values in the table similar to the specified value.
1. **Not like** - list all values in the table not similar to the specified value.
1. **Contains** - list all values in the table, which contains specified value.
1. **Does not contain** - list all values in the table, which does not contain specified value.
1. Begins with - starts with the&nbsp; specified value in the table.
1. **Ends with** - ends with the&nbsp; specified value in the table.
...
1. Once you have sorted or filtered your data with the Make filter utility, click on the **Save as...** button. The "*Save active filter*" screen will be displayed.
...
1. Once you have sorted or filtered your data with the Make filter utility, click on the **Open...** button. The "*Open a saved filter*" screen will be displayed.
