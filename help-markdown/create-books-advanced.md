# Customise your own Set of Books (Advanced)

***

In osFinancials5/TurboCASH5, when creating a Set of Books from scratch using the "[*Customise your own Set of Books (Advanced)?*](<create-books-advanced.md>)" option in the "*Creation wizard*", you have the flexibility to define your chart of accounts according to your specific needs and requirements. It is important to consider some steps when [designing you own Chart of Accounts](<chart-of-accounts-design-steps.md>).

| ![Image](<lib/admon-note.png>) | *Basic Sets of Books for the Firebird database is included in the **bin/CUSTOMISE-EMPTY-BOOKS** folder of your osFinancials5.1/TurboCASH5-3 installation. The following Sets of Books (templates) with longer field lengths and only the three basic control accounts is available in the **bin/CUSTOMISE-EMPTY-BOOKS** folder:* *CUSTOMISE-EMPTY-BOOKS-3X3-DIGITS*&nbsp; *CUSTOMISE-EMPTY-BOOKS-4X3-DIGITS*&nbsp; *CUSTOMISE-EMPTY-BOOKS-5X3-DIGITS*&nbsp; *CUSTOMISE-EMPTY-BOOKS-6X3-DIGITS*&nbsp; *CUSTOMISE-EMPTY-BOOKS-7X3-DIGITS*&nbsp; *CUSTOMISE-EMPTY-BOOKS-8X3-DIGITS*&nbsp; ***Select a CUSTOMIE-EMPTY-BOOKS template:*** ***Copy an existing Set of Books**c Use this option and use the **Browse** button to navigate to the **bin/CUSTOMIE-EMPTY-BOOKS** folder. Enter the name of your Set of Books.* ***Save as**: Open a Set of Books and use the **Browse** button to navigate to the **bin/CUSTOMIE-EMPTY-BOOKS** folder. Once the CUSTOMISE SET OF BOOKS template of your choice is opened, go the **Save as** option on the **Start** ribbon and save your Set of Books with your own name in the books directory.*&nbsp; &nbsp; ***Key features**:* *Description length increased and Added missing entries in the Types table.*&nbsp; *Changed the number of characters in the Descriptions (Account description and Groups description) to 128 characters.* *Should you need any further field length adjustments for osFinancials and TurboCASH, please visit the [osFinancials webshop*](<plugin-field-length.md>)*.* ***Accounts**:* *These Sets of Books only include the 3 control accounts (i.e. Debtors control + Creditors control + Retained earnings) accounts in the Chart of Accounts.*&nbsp; *You may change these three control account numbers and descriptions to meet your specific requirements. It is recommended that you do it before you add or import your ledger. accounts.*&nbsp; *See - [Designing a Chart of Accounts*](<chart-of-accounts-design-steps.htm>) *in this documentation.* ***Updated Types table**:* ***Added**: Groups for Projects -1000, Cost centre 1 -1002, Cost centre 2 - 1003 and Languages -1004.* ***Added**: Paper types - 55 - Till slip and 56 New plain paper types.* |
| --- | --- |
...
2. osFinancials5 / TurboCASH automatically defaults to the option “*Let osFinancials help you to create a Set of Books?*”/ "*Let TurboCASH help you to create a Set of Books?"* , as this is the recommended option for most users. Select the "*Create a Set of Books (Advanced)?*" option.&nbsp;
2. Click on the **Next** button.\
![Image](<lib/books-create-advanced-enter-name.png>)
2. Enter the name for your Set of Books.&nbsp;
...
| ![Image](<lib/admon-note.png>) | *The Directory in which you create the Set of Books is displayed underneath the Location **Browse** button. It will usually be the default directory (e.g. "C: \\ osfinancials5 \\ books" folder in which osFinancials5/TurboCASH5 is installed or directory, which you have specified when you installed osFinancials5/TurboCASH5. If you wish to create your Set of Books in any other directory or location on your system, you may click on the **Browse** button, if desired, to select any folder or drive on the "Pick a directory" screen.*&nbsp; |
| --- | --- |


5. Check the location where you wish to create the Set of Books is correct, and click on the **Next** button. \
...
8. Click on the **Next** button to initiate each of the set up options listed on the right-hand side of the "Creation wizard" screen. Enter and select the necessary information and settings for the following screens:&nbsp;
1) &nbsp;
...
9) After the last setup screen (i.e. [**Stock information**](<stock-information.md>)) is closed, the **Next** button will change to the **Finish** button.

![Image](<lib/books-create-advanced-finish.png>)

10. Click on the **Finish** button. The new Set of Books will automatically be opened automatically and now ready to work in.

| ![Image](<lib/admon-important.png>) | *Before you begin processing transactions, make sure to create your general ledger accounts, bank accounts, tax accounts, debtor accounts, creditor accounts, and review or modify your settings and parameters to ensure accuracy and efficiency.* |
| --- | --- |
...
By default, the [**Bank import plugin**](<plugin-bank-import.md>) setting activated.&nbsp;

The "*Default bank reconciliation*" option **(Setup → System parameters** on **Setup** ribbon) is not selected.&nbsp;
...
If you do not intend to wish to use the [**Bank import plugin**](<plugin-bank-import.md>) at this stage, you need to turn the [**Bank import plugin**](<plugin-bank-import.md>) off (Tick (select) the&nbsp; "*Default bank reconciliation*" field in **Setup → System parameters** (**Setup** ribbon).

The [**Bank import plugin**](<plugin-bank-import.md>) can be activated as it is included in the osFinancials5/TurboCASH5 subscription. &nbsp;

If the [**Bank import plugin**](<plugin-bank-import.md>) is not activated, separate Payments and Receipt batches will be created on the **Bank** tab when you create (add) Bank accounts in **Setup → Accounts** (**Setup** ribbon).
...
- &nbsp;
  ...
  - &#49;004 - [Languages](<setup-groups-languages.md>)&nbsp;
...
| ![Image](<lib/admon-important.png>) | *The number of records in the "TYPES" table is 55 records. After adding the 4 records for the groups and the 2 records for the paper types, the number of records in the "TYPES" table should be 61 records.* |
| --- | --- |
...
If you have created your custom Set of Books in "*English*" as the default language, the osFinancials5/TurboCASH5 interface will be displayed in "*English*". If the osFinancials5/TurboCASH5 interface is displayed in the language of your choice, you can select a different available language in the "[***Switch language***](<switch-language.md>)" (**Start** ribbon).&nbsp;

**Set the default language for your Set Books** - You can choose your language and country in **Setup → [Access control**](<set-default-language.md>). When you reopen your Set of Books, the language in the osFinancials interface, reports, etc. will be displayed in your selected language.&nbsp;
...
Only "*osFinancials5.1.0.127*" /&nbsp; TurboCASH5.1.0.227 (osFinancials5/TurboCASH5 and the version number) will be displayed in the title bar, unless you have already entered your company name in the&nbsp; [**Company info**](<setup-company-info.md>) screen during the creation of the Set of Books. Review and enter the name and contact details as well as the relevant registration numbers of your business in the **Setup** →&nbsp; [**Company info**](<setup-company-info.md>) (**Setup** ribbon).
...
In osFinancials5/TurboCASH5, you have the option to set up to 2 reporting groups for your stock items / inventory items / products, allowing you to categorise search, filter and report on your products more effectively. These reporting groups provide a way to organize and analyse your inventory based on specific criteria.&nbsp;
