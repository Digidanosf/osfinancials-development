# Create / Edit Stock items - Purchases (no stock)
...
**To create a stock item - Purchases (no stock):**&nbsp;

1. On the **Default** ribbon, select **Stock items** (**F12**).

2) Click on the **New** button.&nbsp; A blank Stock form will be displayed.&nbsp;
2) Select the "*Purchases (no stock)"* stock item type. The Stock entry form is displayed as follows: \
![Image](<lib/stock-new-type-purchase-no-stock.png>)
...
![Image](<lib/stock-new-type-purchase-no-stock-ledger.png>)
