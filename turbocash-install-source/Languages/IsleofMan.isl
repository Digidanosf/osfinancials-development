; *** Inno Setup version 6.3.3+ Isle of Man English (en-IM) messages ***
; Tailored for the Isle of Man market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (IM)

[LangOptions]
LanguageName=English (Isle of Man)
LanguageID=$0409
...
SelectTasksLabel2=Select the additional tasks the wizard should perform while installing [name], and click Next.
