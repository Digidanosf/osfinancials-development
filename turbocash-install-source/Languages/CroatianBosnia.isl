; *** Inno Setup version 6.3.3+ Croatian (Bosnia and Herzegovina) messages ***
; Prilagođeno za tržište Bosne i Hercegovine - 262 retka - ; Izvor : TurboCASH 2026 Referenca - Regionalna verzija (BiH)

[LangOptions]
LanguageName=Hrvatski (BiH)
LanguageID=$041A
...
NoUninstallWarning=Instalacioni čarobnjak je otkrio da su sljedeće komponente već instalirane na vašem sistemu:%n%n%1%n%nPoništavanje odabira ovih komponenti ih neće deinstalirati.%n%nŽelite li nastaviti usprkos tome?
ComponentSize1=%1 KB
ComponentSize2=%1 MB
...
InvalidPath=Morate unijeti punu putanju sa slovom pogona; npr.:%n%nC:\APP%n%nili UNC putanju:%n%n\\server\dijeljeno
