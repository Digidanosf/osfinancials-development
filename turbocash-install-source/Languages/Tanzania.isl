; *** Inno Setup version 6.3.3+ Tanzania English (en-TZ) messages ***
; Tailored for the Tanzania market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (TZ)
