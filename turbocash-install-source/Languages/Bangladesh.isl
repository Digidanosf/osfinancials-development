; *** Inno Setup version 6.3.3+ Bangladesh English (en-BD) messages ***
; Tailored for the Bangladesh market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (BD)

[LangOptions]
LanguageName=English (Bangladesh)
LanguageID=$0409
