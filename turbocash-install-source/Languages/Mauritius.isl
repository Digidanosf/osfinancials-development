; *** Inno Setup version 6.3.3+ Mauritius English (en-MU) messages ***
; Tailored for the Mauritian market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (MU)

[LangOptions]
LanguageName=English (Mauritius)
LanguageID=$1809
