; *** Inno Setup version 6.3.3+ Barbados English (en-BB) messages ***
; Tailored for the Barbados market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (BB)

[LangOptions]
LanguageName=English (Barbados)
LanguageID=$0409
