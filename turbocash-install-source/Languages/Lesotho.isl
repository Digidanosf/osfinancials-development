; *** Inno Setup version 6.3.3+ Lesotho English (en-LS) messages ***
; Tailored for the Basotho market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (LS)

[LangOptions]
LanguageName=English (Lesotho)
LanguageID=$0409
