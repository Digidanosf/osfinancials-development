; *** Inno Setup version 6.3.3+ Rwanda English (en-RW) messages ***
; Tailored for the Rwandan market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (RW)

[LangOptions]
LanguageName=English (Rwanda)
LanguageID=$0409
