; *** Inno Setup version 6.3.3+ English (Republic of South Africa) messages ***
; Updated and Optimised for TurboCASH5-4 Release Candidate

[LangOptions]
LanguageName=English (Republic of South Africa)
LanguageID=$0409
LanguageCodePage=0
...
; ==========================================
;     DISK SPACE TRANSLATIONS (SA ENGLISH)
; ==========================================
...
CustomInstallation=Customise installation
...
WelcomeLabel2=This programme will install [name] on your computer.
...
; === SetupLdr Messages ===
SetupLdrStartupMessage=This programme will install %1. Do you wish to continue?
...
SetupFileMissing=The file %1 is missing from the installation directory. Please correct the problem or obtain a new copy of the programme.
SetupFileCorrupt=The installation files are corrupt. Please obtain a new copy of the programme.
SetupFileCorruptOrWrongVer=The installation files are corrupt or incompatible with this version of the installer. Please correct the problem or obtain a new copy of the programme.
NotOnThisPlatform=This programme will not run on %1.
OnlyOnThisPlatform=This programme must be run on %1.
OnlyOnTheseArchitectures=This programme can only be installed on versions of Windows designed for the following processor architectures:%n%n%1
WinVersionTooLowError=This programme requires %1 version %2 or newer.
WinVersionTooHighError=This programme cannot be installed on %1 version %2 or newer.
AdminPrivilegesRequired=You must be logged in as an administrator to install this programme.
PowerUserPrivilegesRequired=You must be logged in as an administrator or as a member of the Power Users group to install this programme.
...
ExitSetupMessage=The installation is not yet complete. If you exit now, the programme will not be installed.%n%nYou may run the installer again at a later date to complete the installation.%n%nExit the installer?
...
; === "Welcome" Wizard Page ===
WelcomeLabel1=Welcome to the [name] Setup Wizard
WelcomeLabel2=This programme will install [name] on your computer.%n%nIt is recommended that you close all other applications before continuing.
...
SelectStartMenuFolderDesc=Where should the installer place the programme shortcuts? NOTE: Do not select the core PROGRAM or previous TurboCASH folders.
SelectStartMenuFolderLabel3=The installer will place the programme shortcuts in the following Start Menu folder.
...
PreviousInstallNotCompleted=The installation/removal of a previous programme was not completed. You must restart your computer to complete that installation.%n%nAfter restarting the computer, you can run the installer again to complete the installation of [name].
...
FinishedLabel=The [name] installation is complete. The programme can be launched using the installed shortcuts.
...
TypeCustom=Customise Installation
