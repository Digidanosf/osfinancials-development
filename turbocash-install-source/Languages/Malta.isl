; *** Inno Setup version 6.3.3+ Malta English (en-MT) messages ***
; Tailored for the Maltese market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (MT)

[LangOptions]
LanguageName=English (Malta)
LanguageID=$0409
