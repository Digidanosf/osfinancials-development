; *** Inno Setup version 6.3.3+ Namibia English (en-NA) messages ***
; Tailored for the Namibian market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (NA)

[LangOptions]
LanguageName=English (Namibia)
LanguageID=$0409
