; *** Inno Setup version 6.3.3+ Botswana English (en-BW) messages ***
; Tailored for the Botswana market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (BW)

[LangOptions]
LanguageName=English (Botswana)
LanguageID=$0409
