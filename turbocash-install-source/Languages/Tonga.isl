; *** Inno Setup version 6.3.3+ Tonga English (en-TO) messages ***
; Tailored for the Tongan market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (TO)

[LangOptions]
LanguageName=English (Tonga)
LanguageID=$0409
