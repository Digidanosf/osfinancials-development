; *** Inno Setup version 6.3.3+ Zimbabwe English (en-ZW) messages ***
; Tailored for the Zimbabwean market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (ZW)

[LangOptions]
LanguageName=English (Zimbabwe)
LanguageID=$0c09
