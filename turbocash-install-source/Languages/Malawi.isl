; *** Inno Setup version 6.3.3+ Malawi English (en-MW) messages ***
; Tailored for the Malawian market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (MW)

[LangOptions]
LanguageName=English (Malawi)
LanguageID=$0409
