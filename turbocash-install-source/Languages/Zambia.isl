; *** Inno Setup version 6.3.3+ Zambia English (en-ZM) messages ***
; Tailored for the Zambian market - 262 lines - Source: TurboCASH 2026 Reference - Regional Version (ZM)

[LangOptions]
LanguageName=English (Zambia)
LanguageID=$0409
...
PreviousInstallNotCompleted=The previous installation or uninstallation was not completed. You must restart your computer to complete that process.%n%nAfter restarting, run the Setup Wizard again to complete the installation of the_name.
